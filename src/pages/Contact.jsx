    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6" action="#" method="POST">
          ...
          <div>
            <button type="submit" className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white" style={{ backgroundColor: '#C39898', hover: { backgroundColor: '#DBB5B5' , text: 'black'} }}>
              Send Message
            </button>
          </div>
        </form>
      ...
      <footer className="mt-8 w-full text-center">
        <div className="animation-container mx-auto w-16 h-16 bg-gray-300 rounded-full"></div>
      </footer>
    </div>
    {/* </div> */}
    </>
